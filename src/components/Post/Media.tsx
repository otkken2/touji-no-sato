          ...
          if(isDetailPage){
            return (
              ...
              <div key={ImageIndex} className="w-[100vw] keen-slider__slide" >
                <ReactPlayer width='100%' url={`${MEDIA_BASE_URL}${url}`} controls={true}/>
              </div>
              :
              ...
              <div className="w-full keen-slider__slide" >
                ...
                <img key={ImageIndex}  src={`${MEDIA_BASE_URL}${url}`} alt="" className='w-full h-full' />
              </div>
            )
          }
          // リンクあり
            ...
            :
              <Link key={ImageIndex} href={`/post/${post.id}`}>
                <div className="w-full h-auto keen-slider__slide" >
                  <img  src={`${MEDIA_BASE_URL}${url}`} alt="" className='w-full h-auto' />
                </div>
              </Link>
            );
        })}
