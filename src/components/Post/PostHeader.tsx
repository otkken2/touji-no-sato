      ...
      <div className='flex'>
        <div className={`w-10 h-10 bg_primary rounded-full`}>
          <Link href={`/profile/${userId}`}>
            {/* <img src={switchIconUrlByEnv() ?? '/mypage.svg'} alt="プロフィール" className='w-full h-full rounded-full'/> */}
            <img src={API_URL + userIconUrl ?? '/mypage.svg'} alt="プロフィール" className='w-full h-full rounded-full'/>
          </Link>
        </div>
